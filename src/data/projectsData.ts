...
export const projectsData: ProjectData[] = [
  {
    ...
    shortDescription:
      "Led the development of a comprehensive document management platform for enterprise clients.",
    fullDescription:
  ...
  },
  {
    ...
    shortDescription:
      "Developed a secure cloud storage and sync service with end-to-end encryption.",
    fullDescription:
  ...
  },
  {
    ...
    shortDescription:
      "Created an intuitive file classification system with AI-assisted categorization.",
    fullDescription:
  ...
  },
  {
    ...
    shortDescription:
      "Built custom integrations connecting document systems with client enterprise software.",
    fullDescription:
  ...
  },
  {
    ...
    shortDescription:
      "Developed interactive data visualization dashboards using amCharts at Sonatafy Technology.",
    fullDescription:
  ...
  },
  {
    ...
    shortDescription:
      "Implemented feature flags with Launch Darkly for controlled feature releases.",
    fullDescription:
  ...
  },
  {
    ...
    shortDescription:
      "Built a student database system for the university library during my studies.",
    fullDescription:
