...
export const createSnakeGame = ({
  ...
  const initializeSnake = () => {
    ...
    const centerX =
      sideNavWidth + Math.floor(playableWidth / 2 / gridSize) * gridSize;
  ...
  const moveSnake = () => {
    ...
    if (!particleEaten) {
      ...
      score += 1;
      if (score % 3 === 0) {
        // Speed increases more frequently (every 3 points instead of 5)
