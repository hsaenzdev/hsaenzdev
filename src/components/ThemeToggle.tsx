    ...
    >
      {mode === 'dark' ? 
        <LightModeIcon sx={{ 
          ...
          '@keyframes pulse': {
            '0%': { filter: `drop-shadow(0 0 2px ${theme.palette.accent1.main})` },
            '50%': { filter: `drop-shadow(0 0 6px ${theme.palette.accent1.main})` },
            '100%': { filter: `drop-shadow(0 0 2px ${theme.palette.accent1.main})` }
          }
        }} /> : 
        <DarkModeIcon sx={{ 
          ...
          '@keyframes glow': {
            '0%': { filter: `drop-shadow(0 0 2px ${theme.palette.accent2.main})` },
            '50%': { filter: `drop-shadow(0 0 6px ${theme.palette.accent2.main})` },
            '100%': { filter: `drop-shadow(0 0 2px ${theme.palette.accent2.main})` }
          }
        }} />
      }
    </IconButton>
