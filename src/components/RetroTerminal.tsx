  ...
  useEffect(() => {
    const handleKeyDown = (e: KeyboardEvent) => {
      ...
      if (["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(e.key)) {
        ...
        const terminalFocused =
          document.activeElement?.closest(".terminal-container") !== null;
    ...
    const preventTerminalScroll = (e: KeyboardEvent) => {
      if (["ArrowUp", "ArrowDown"].includes(e.key)) {
        ...
        if (
          terminalElem &&
          (terminalElem === document.activeElement ||
            terminalElem.contains(document.activeElement))
        ) {
          e.preventDefault();
        }
      }
    ...
    window.addEventListener("keydown", preventTerminalScroll, {
      capture: true,
    });

    return () => {
      window.removeEventListener("keydown", handleKeyDown);
      window.removeEventListener("keydown", preventTerminalScroll, {
        capture: true,
      });
    };
  ...
  const processCommand = (cmd: string) => {
    ...
    switch (cleanedCmd) {
      ...
      case "contact":
        ...
        setCommandHistory((prev) => [
          ...prev,
          "> Email: hectors.digital@gmail.com",
        ]);
        setCommandHistory((prev) => [
          ...prev,
          "> LinkedIn: linkedin.com/in/saenzo",
        ]);
        break;
      case "github":
      ...
      case "snake":
        ...
        if (isGameEnabled && gameState === "ACTIVE") {
          ...
          setCommandHistory((prev) => [
            ...prev,
            "> Eat the glowing particles to grow longer",
          ]);
          setCommandHistory((prev) => [
            ...prev,
          ...
          setCommandHistory((prev) => [
            ...prev,
            "> The score will appear at the top right of the screen",
          ]);
      ...
      default:
        setCommandHistory((prev) => [
          ...prev,
          `> Command not found: ${cleanedCmd}. Type 'help' for available commands.`,
        ]);
    }
  };
            ...
            >
              {introComplete && (
                <Box sx={{ mb: 2 }}>
                  ...
                  >
                    Welcome to my interactive terminal. Type 'help' for
                    available commands.
                  </Typography>
                </Box>
              )}
