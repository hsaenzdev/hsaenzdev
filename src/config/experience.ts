...
export const experienceItems: ExperienceItem[] = [
  {
    ...
    shortDescription: "Developing interactive data visualizations and full-stack features using TypeScript/React, Material UI, and Elixir/Phoenix.",
    description: [
  ...
  },
  {
    ...
    period: "2024",
    shortDescription: "Earned AWS Certified Cloud Practitioner and Developer Associate certifications.",
    description: [
  ...
  },
  {
    ...
    period: "2014 - 2021",
    shortDescription: "Led development of document management platform, cloud storage service, and enterprise integrations.",
    description: [
  ...
  },
  {
    ...
    period: "2010 - 2015",
    shortDescription: "Computer Science degree with focus on programming fundamentals and database systems.",
    description: [
